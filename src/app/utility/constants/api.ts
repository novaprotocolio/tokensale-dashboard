...
export class API {
  ...
  */
  ...
  public static ETH_PRICE = environment.apiURL + 'ico/etherPrice';
  ...
  */
  ...
  public static DASHBOARD = environment.apiURL + 'ico';

  /* Place your balance api here */

  public static CHECK_BITCOIN_BALANCE =
    'https://blockchain.info/q/addressbalance/';

  /* Ethereum Price Api */

  public static GET_ETHER = environment.apiURL + 'ico/getEther';
}

export class IMAGEConstants {
  public static IMAGE_FILE_SIZE_LIMIT = 1e7;
  public static VALID_IMAGE_SIZE =
    'Image should be gif/jpeg/jpg/png and less than 10MB';
}
